...
st.markdown("<p style='text-align: center;'>Hem konuşarak hem yazarak iletişim kurabilirsiniz.</p>", unsafe_allow_html=True)
...
with col2:
    yazi_girdisi = st.chat_input("Buraya yazın...")
